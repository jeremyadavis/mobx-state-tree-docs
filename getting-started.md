...
You may need to use the list of todos filtered by completion in various locations in your application. Even if accessing the list of todos and filter them every time may look like a viable solution, if the filter logic is complex or changes over time you'll find that it's not a viable solution.
